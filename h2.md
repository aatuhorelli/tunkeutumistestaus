...
````
Koneet luotiin onnistuneesti, mutta ainakin Kali karkasi edelleen internetin puolelle. Kali ei myöskään tuntunut tunnistavan olevansa osa VagrantFilessä määriteltyä verkkoa. Tarkastin virtuaali-Kalin ip-osoitteet komennolla ``$ ip address`` ja koitin pingata sille määriteltyä osoitetta ``$ ping 192.168.57.101`` siinä onnistumatta. Lisäsäätöä vaadittiin.

![Add file: verkko-ongelmia](/img/h2/vagrant_kali_verkko-ongelma.png)
>192.168.57.x-verkkoa ei löydy, ping ei onnistu
