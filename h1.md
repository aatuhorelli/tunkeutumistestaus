...
Lopuksi asennusohjelma kysyi asennetaanko GRUB boot loader. Kyseessä on virtuaalikoneen ainoa käyttöjärjestelmä, joten asennuksella ei käsittääkseni pitäisi olla haittavaikutuksia. Valitsin Yes -> Continue, ja tämän jälkeen valitsin boot loaderin asennettavan aiemmin asennuksessa luomalleni partitiolle. Tämän jälkeen asennus oli valmis.
